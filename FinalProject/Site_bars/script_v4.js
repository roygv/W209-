...
// Actions depending on live switch
...
width = +focus.attr("width") - margin.left - margin.right,
width2 = +context.attr("width") - margin.left - margin.right,
height = +focus.attr("height") - margin.top - margin.bottom,
height2 = +context.attr("height") - margin2.top - margin2.bottom;
